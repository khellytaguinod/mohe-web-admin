...
class ManageAttache extends Component {
  state = {
    email: "",
    password: "",
    firstName: "",
  ...
  handleSubmit = (e) => {
    ...
    e.preventDefault();
    this.props.addAttache(this.state);
  };
        ...
        <div className="card z-depth-0">
          <ul class="collection with-header">
            <li class="collection-header">
              <h5>Create Attaché's Account</h5>
            </li>
          </ul>
          <form className="form-style" onSubmit={this.handleSubmit}>
            ...
            <div className="input-field">
              <labe>Choose country that attaché's will handle</labe>
              <select
            ...
            <div className="input-field">
              ...
              >
                Create Attaché Account
              </button>
              <div className="center red-text">
                {createAccountFailed ? <p>{createAccountFailed}</p> : null}
              </div>
...
const mapStateToProps = (state) => {
  return {
    createAccountSuccess: state.attache.successMsg,
    createAccountFailed: state.attache.failedMsg,
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageAttache);
